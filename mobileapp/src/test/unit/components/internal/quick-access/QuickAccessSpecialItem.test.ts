...
import { QuickAccessSpecialItem } from '$lib/components/internal/quick-access';
...
describe('widgets/quick-access/QuickAccessSpecialItem', () => {
	...
	describe('organization-card widget', () => {
		it('renders organization name', () => {
			const { container } = render(QuickAccessSpecialItem, {
				props: {
					activity: undefined,
					editMode: false,
					index: 0,
