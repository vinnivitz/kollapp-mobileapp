 ...
 * Categories are designed from user perspective to allow granular notification preferences.
 */
public enum NotificationType {
    ...
    GENERAL,
    /**
     * Notifications about the users membership status in organizations.
    ...
    MEMBERSHIP_STATUS,
    /**
     * Notifications about new members joining the users organization or pending member requests.
    ...
    MEMBERSHIP_CHANGES,
    /**
     * Notifications about activities/events in the users organizations.
     ...
     * User decision: "Do I want to receive direct messages?"
     */
    MESSAGES,
    /**
