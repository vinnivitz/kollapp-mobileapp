...
import org.kollappbackend.core.config.properties.CorsProperties;
import org.kollappbackend.user.application.service.impl.KollappUserDetailsServiceImpl;
...
public class WebSecurityConfig {
    ...
    /**
     * It configures the allowed origins, methods, headers, and credentials of the CORS.
     *
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowCredentials(
                Boolean.parseBoolean(corsProperties.getAllowCredentials()));
    ...
    /**
     * It configures the security filter chain with the XXS protection, content type options, frame
     * options, HSTS, CSP, CORS, CSRF, exception handling, session management, and authorization.
     *
