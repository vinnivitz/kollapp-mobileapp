...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthenticatedKollappUser authenticate(String username, String password) {
        ...
        return AuthenticatedKollappUser.builder().accessToken(accessToken).refreshToken(refreshToken)
                .username(kollappUserDetails.getUsername()).email(kollappUserDetails.getEmail()).build();
    }
